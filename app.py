...
def display_history(chain):
    ...
    with container:
        with st.form(key="my_form",clear_on_submit=True):
            user_input=st.text_input("Question :",placeholder="Askk About your documents",key="input")
...
def main():
    ...
    uploader_files=st.sidebar.file_uploader("Uplaoded files",accept_multiple_files=True)
